# 🌸 Instagram Perfume CRM & Automation Bot
...
**سیستم مدیریت ارتباط با مشتری (CRM) و ربات هوشمند اتوماسیون دایرکت و کامنت اینستاگرام برای فروشگاه‌های عطر، اسانس و محصولات لوکس**
...
این سیستم یک پلتفرم جامع و مدرن برای اتوماسیون پیج‌های تجاری اینستاگرام است. برخلاف ربات‌های سنتی و پرریسک مبتنی بر شبیه‌سازهای غیررسمی، این پروژه از **API رسمی مبتنی بر پلتفرم ابری Zernio** و **وب‌هوک‌های رویدادمحور (Event-Driven Webhooks)** استفاده می‌کند که **ریسک بن شدن پیج را به صفر می‌رساند**.
